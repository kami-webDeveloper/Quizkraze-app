...
export const getUserSubmissions = (id) =>
  request(
    `${API_URL}/api/v1/results/user-submissions/${id}`,
    buildGetOptions,
...
export const submitQuiz = (id, answerData) =>
  request(
    `${API_URL}/api/v1/results/submit-quiz/${id}`,
...
export const getSubmission = (id) =>
  request(
    `${API_URL}/api/v1/results/submission/${id}`,
    buildGetOptions,
...
export const getQuizSubmissions = (id) =>
  request(
    `${API_URL}/api/v1/results/quiz-submissions/${id}`,
    buildGetOptions,
...
export const deleteSubmission = (id) =>
  request(
    `${API_URL}/api/v1/results/delete-submission/${id}`,
    {
      method: "DELETE",
      credentials: "include",
    },
